...
| `tlsEnabled` _boolean_ | TLSEnabled enables TLS for connections to the Redis master.<br />Required when the Redis/Valkey cluster has transit encryption enabled. |  | Optional: \{\} <br /> |
