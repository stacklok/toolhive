...
func (in *EmbeddedAuthServerConfig) DeepCopyInto(out *EmbeddedAuthServerConfig) {
	*out = *in
	...
	if in.OnUpstreamAuthFailure != nil {
		in, out := &in.OnUpstreamAuthFailure, &out.OnUpstreamAuthFailure
		*out = new(UpstreamAuthFailurePolicy)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UpstreamAuthFailurePolicy) DeepCopyInto(out *UpstreamAuthFailurePolicy) {
	*out = *in
	if in.TriggerOn != nil {
		in, out := &in.TriggerOn, &out.TriggerOn
		*out = make([]UpstreamAuthFailureMatcher, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UpstreamAuthFailurePolicy.
func (in *UpstreamAuthFailurePolicy) DeepCopy() *UpstreamAuthFailurePolicy {
	if in == nil {
		return nil
	}
	out := new(UpstreamAuthFailurePolicy)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UpstreamAuthFailureMatcher) DeepCopyInto(out *UpstreamAuthFailureMatcher) {
	*out = *in
	if in.Status != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UpstreamAuthFailureMatcher.
func (in *UpstreamAuthFailureMatcher) DeepCopy() *UpstreamAuthFailureMatcher {
	if in == nil {
		return nil
	}
	out := new(UpstreamAuthFailureMatcher)
	in.DeepCopyInto(out)
	return out
}
