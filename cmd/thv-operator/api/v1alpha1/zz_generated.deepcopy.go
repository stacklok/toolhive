...
func (in *CompositeToolSpec) DeepCopyInto(out *CompositeToolSpec) {
	*out = *in
	if in.Parameters != nil {
		...
		*out = make(map[string]ParameterSpec, len(*in))
...
func (in *MCPRegistrySourceConfig) DeepCopyInto(out *MCPRegistrySourceConfig) {
	*out = *in
	in.MCPRegistrySource.DeepCopyInto(&out.MCPRegistrySource)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TokenCacheConfig) DeepCopyInto(out *TokenCacheConfig) {
	*out = *in
	if in.Memory != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TokenCacheConfig.
func (in *TokenCacheConfig) DeepCopy() *TokenCacheConfig {
	if in == nil {
		return nil
	}
	out := new(TokenCacheConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VirtualMCPServerSpec) DeepCopyInto(out *VirtualMCPServerSpec) {
	*out = *in
	...
	if in.TokenCache != nil {
		in, out := &in.TokenCache, &out.TokenCache
		*out = new(TokenCacheConfig)
		(*in).DeepCopyInto(*out)
	}
