...
func TestBuiltinFields_AllFieldsRegistered(t *testing.T) {
	...
	for _, expectedField := range expectedFields {
		...
		assert.NotEmpty(t, spec.DisplayName, "field %q should have a display name", expectedField)
		assert.NotEmpty(t, spec.HelpText, "field %q should have help text", expectedField)
	}
}
