...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ListChangedConfig) DeepCopyInto(out *ListChangedConfig) {
	*out = *in
	if in.Enabled != nil {
	...
	if in.DisabledWorkloads != nil {
		in, out := &in.DisabledWorkloads, &out.DisabledWorkloads
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ListChangedConfig.
func (in *ListChangedConfig) DeepCopy() *ListChangedConfig {
	if in == nil {
		return nil
	}
	out := new(ListChangedConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OperationalConfig) DeepCopyInto(out *OperationalConfig) {
	*out = *in
	...
	if in.ListChanged != nil {
		in, out := &in.ListChanged, &out.ListChanged
		*out = new(ListChangedConfig)
		(*in).DeepCopyInto(*out)
	}
}
