...
//
//	if validator, ok := provider.(idp.IDTokenNonceValidator); ok {
...
//   - UpstreamConfig: Configuration for upstream IDP connection
//   - IDTokenClaims: Parsed claims from ID token
//
// # Usage
//
//	config := &idp.UpstreamConfig{
...
//	}
//
//	provider, err := idp.NewOIDCProvider(ctx, config)
//	if err != nil {
//	    return err
//	}
//
