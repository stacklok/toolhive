...
func (in *InboundGrantsConfig) DeepCopyInto(out *InboundGrantsConfig) {
	*out = *in
	if in.SPIFFEClientAuth != nil {
		...
		*out = make([]SPIFFEClientAuthConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SPIFFEClientAuthConfig) DeepCopyInto(out *SPIFFEClientAuthConfig) {
	*out = *in
	if in.Methods != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SPIFFEClientAuthConfig.
func (in *SPIFFEClientAuthConfig) DeepCopy() *SPIFFEClientAuthConfig {
	if in == nil {
		return nil
	}
	out := new(SPIFFEClientAuthConfig)
	in.DeepCopyInto(out)
	return out
}
