...
func init() {
	stopCmd.Flags().IntVar(&stopTimeout, "timeout", 30, "Timeout in seconds before forcibly stopping the workload (default: 30)")
	stopCmd.Flags().BoolVar(&stopAll, "all", false, "Stop all running MCP servers (default: false)")
