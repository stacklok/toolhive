...
type Config struct {
	...
	IncomingAuth *IncomingAuthConfig `json:"incoming_auth,omitempty"`

	// OutgoingAuth configures how the virtual MCP server authenticates to backends.
	OutgoingAuth *OutgoingAuthConfig `json:"outgoing_auth,omitempty"`
	...
	CompositeTools []*CompositeToolConfig `json:"composite_tools,omitempty"`

	// TokenCache configures token caching.
	TokenCache *TokenCacheConfig `json:"token_cache,omitempty"`
...
type OutgoingAuthConfig struct {
	...
	Default *BackendAuthStrategy `json:"default,omitempty"`

	// Backends contains per-backend auth configuration.
	Backends map[string]*BackendAuthStrategy `json:"backends,omitempty"`
}
...
type AggregationConfig struct {
	...
	ConflictResolution vmcp.ConflictResolutionStrategy `json:"conflict_resolution"`

	// ConflictResolutionConfig contains strategy-specific configuration.
	ConflictResolutionConfig *ConflictResolutionConfig `json:"conflict_resolution_config,omitempty"`
...
type ConflictResolutionConfig struct {
	...
	PrefixFormat string `json:"prefix_format,omitempty"`
...
type MemoryCacheConfig struct {
	...
	TTLOffset Duration `json:"ttl_offset"`
}
...
type TimeoutConfig struct {
	...
	PerWorkload map[string]Duration `json:"per_workload,omitempty"`
}
...
type FailureHandlingConfig struct {
	...
	PartialFailureMode string `json:"partial_failure_mode"`
