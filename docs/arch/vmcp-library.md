...
| `pkg/vmcp/app` | Experimental | Config-driven assembly API for embedders; `BuildCore`, `BuildServerConfig`, `Option`. Signatures may change as embedder patterns stabilise |
