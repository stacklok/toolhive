...
func init() {
	...
	OtelCmd.AddCommand(createOTELSetCommand(
		"otel-enable-prometheus-metrics-path", "enable-prometheus-metrics-path",
		"Prometheus metrics path flag", "true"))
	OtelCmd.AddCommand(createOTELGetCommand(
		"otel-enable-prometheus-metrics-path", "enable-prometheus-metrics-path",
		"Prometheus metrics path flag"))
	OtelCmd.AddCommand(createOTELUnsetCommand(
		"otel-enable-prometheus-metrics-path", "enable-prometheus-metrics-path",
		"Prometheus metrics path flag"))
}
