...
type ServerAPI interface {
	...
	Search(ctx context.Context, query string, opts *SearchOptions) ([]*Server, error)
}
...
type SecretAPI interface {
	...
	// List lists secrets.
	List(ctx context.Context, opts *SecretListOptions) ([]string, error)
...
type ConfigAPI interface {
	...
	ListRegisteredClients(ctx context.Context, opts *ConfigListRegisteredClientsOptions) ([]string, error)
...
type VersionAPI interface {
	...
	Get(ctx context.Context, opts *VersionOptions) (string, error)
}
