...
| operator.image | string | `"ghcr.io/stacklok/toolhive/operator:v0.2.8"` | Container image for the operator |
...
| operator.toolhiveRunnerImage | string | `"ghcr.io/stacklok/toolhive/proxyrunner:v0.2.8"` | Image to use for Toolhive runners |
