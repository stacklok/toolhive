...
//
// It is declared here, in this leaf package, rather than as authserver's own
// type, for the same import-direction reason as SPIFFEAuthenticationMethod
// above: package registration (server/registration) needs this type for
// AuthenticatedSPIFFEClient's principal field, and registration cannot import
// authserver.
