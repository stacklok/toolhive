...
![Version: 0.24.0](https://img.shields.io/badge/Version-0.24.0-informational?style=flat-square)
...
| operator.image | string | `"ghcr.io/stacklok/toolhive/operator:v0.24.0"` | Container image for the operator |
...
| operator.toolhiveRunnerImage | string | `"ghcr.io/stacklok/toolhive/proxyrunner:v0.24.0"` | Image to use for Toolhive runners |
