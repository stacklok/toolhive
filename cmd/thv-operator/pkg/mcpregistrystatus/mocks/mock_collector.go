...
func (m *MockSyncStatusCollector) Status() *v1alpha1.SyncStatus {
	m.ctrl.T.Helper()
...
func (mr *MockSyncStatusCollectorMockRecorder) Status() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Status", reflect.TypeOf((*MockSyncStatusCollector)(nil).Status))
}
