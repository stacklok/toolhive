...
| operator.image | string | `"ghcr.io/stacklok/toolhive/operator:v0.6.10"` | Container image for the operator |
...
| operator.toolhiveRunnerImage | string | `"ghcr.io/stacklok/toolhive/proxyrunner:v0.6.10"` | Image to use for Toolhive runners |
| operator.vmcpImage | string | `"ghcr.io/stacklok/toolhive/vmcp:v0.6.10"` | Image to use for Virtual MCP Server (vMCP) deployments |
...
| registryAPI | object | `{"image":"ghcr.io/stacklok/thv-registry-api:v0.3.5","serviceAccount":{"annotations":{},"automountServiceAccountToken":true,"labels":{},"name":"toolhive-registry-api"}}` | All values for the registry API deployment and associated resources |
| registryAPI.image | string | `"ghcr.io/stacklok/thv-registry-api:v0.3.5"` | Container image for the registry API |
