...
func TestNewClient_PublicClient(t *testing.T) {
	...
	// Public clients are DefaultOpenIDConnectClient (not DefaultClient) so
	// TokenEndpointAuthMethod is set.
	_, isOIDC := client.(*fosite.DefaultOpenIDConnectClient)
	assert.True(t, isOIDC, "public client should be *fosite.DefaultOpenIDConnectClient")
