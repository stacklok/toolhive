...
//
//	mockgen -destination=mocks/mock_storage.go -package=mocks -source=types.go Storage,PendingAuthorizationStorage,DeviceCodeStorage,PendingDeviceLoginStorage,PendingDeviceConfirmationStorage,AssertionJWTConsumer,ClientRegistry,UpstreamTokenStorage,UpstreamTokenRefresher,UserStorage,DCRCredentialStore
//
...
// UpdateDCRCredentialsIfPresent mocks base method.
func (m *MockDCRCredentialStore) UpdateDCRCredentialsIfPresent(ctx context.Context, creds *storage.DCRCredentials) (*storage.DCRCredentials, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateDCRCredentialsIfPresent", ctx, creds)
	ret0, _ := ret[0].(*storage.DCRCredentials)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UpdateDCRCredentialsIfPresent indicates an expected call of UpdateDCRCredentialsIfPresent.
func (mr *MockDCRCredentialStoreMockRecorder) UpdateDCRCredentialsIfPresent(ctx, creds any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockDeviceCodeStorage) DeleteDeviceRequest(ctx context.Context, deviceCode string) error {
	m.ctrl.T.Helper()
...
func (mr *MockDeviceCodeStorageMockRecorder) DeleteDeviceRequest(ctx, deviceCode any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteDeviceRequest", reflect.TypeOf((*MockDeviceCodeStorage)(nil).DeleteDeviceRequest), ctx, deviceCode)
}

// LoadDeviceRequestByDeviceCode mocks base method.
func (m *MockDeviceCodeStorage) LoadDeviceRequestByDeviceCode(ctx context.Context, deviceCode string) (*storage.DeviceRequest, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDeviceCodeStorageMockRecorder) LoadDeviceRequestByDeviceCode(ctx, deviceCode any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LoadDeviceRequestByDeviceCode", reflect.TypeOf((*MockDeviceCodeStorage)(nil).LoadDeviceRequestByDeviceCode), ctx, deviceCode)
}

// LoadDeviceRequestByUserCode mocks base method.
func (m *MockDeviceCodeStorage) LoadDeviceRequestByUserCode(ctx context.Context, userCode string) (*storage.DeviceRequest, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDeviceCodeStorageMockRecorder) LoadDeviceRequestByUserCode(ctx, userCode any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LoadDeviceRequestByUserCode", reflect.TypeOf((*MockDeviceCodeStorage)(nil).LoadDeviceRequestByUserCode), ctx, userCode)
}

// MarkDeviceRequestAuthorized mocks base method.
func (m *MockDeviceCodeStorage) MarkDeviceRequestAuthorized(ctx context.Context, deviceCode, resolvedUserID, resolvedUserName, resolvedUserEmail, sessionID string) error {
	m.ctrl.T.Helper()
...
func (mr *MockDeviceCodeStorageMockRecorder) MarkDeviceRequestAuthorized(ctx, deviceCode, resolvedUserID, resolvedUserName, resolvedUserEmail, sessionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MarkDeviceRequestAuthorized", reflect.TypeOf((*MockDeviceCodeStorage)(nil).MarkDeviceRequestAuthorized), ctx, deviceCode, resolvedUserID, resolvedUserName, resolvedUserEmail, sessionID)
}

// MarkDeviceRequestDenied mocks base method.
func (m *MockDeviceCodeStorage) MarkDeviceRequestDenied(ctx context.Context, deviceCode string) error {
	m.ctrl.T.Helper()
...
func (mr *MockDeviceCodeStorageMockRecorder) MarkDeviceRequestDenied(ctx, deviceCode any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MarkDeviceRequestDenied", reflect.TypeOf((*MockDeviceCodeStorage)(nil).MarkDeviceRequestDenied), ctx, deviceCode)
}

// StoreDeviceRequest mocks base method.
func (m *MockDeviceCodeStorage) StoreDeviceRequest(ctx context.Context, device *storage.DeviceRequest) error {
	m.ctrl.T.Helper()
...
func (mr *MockDeviceCodeStorageMockRecorder) StoreDeviceRequest(ctx, device any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StoreDeviceRequest", reflect.TypeOf((*MockDeviceCodeStorage)(nil).StoreDeviceRequest), ctx, device)
}

// UpdateDeviceRequestLastPolledAt mocks base method.
func (m *MockDeviceCodeStorage) UpdateDeviceRequestLastPolledAt(ctx context.Context, deviceCode string, polledAt time.Time) error {
	m.ctrl.T.Helper()
...
func (mr *MockDeviceCodeStorageMockRecorder) UpdateDeviceRequestLastPolledAt(ctx, deviceCode, polledAt any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateDeviceRequestLastPolledAt", reflect.TypeOf((*MockDeviceCodeStorage)(nil).UpdateDeviceRequestLastPolledAt), ctx, deviceCode, polledAt)
}

// MockPendingDeviceLoginStorage is a mock of PendingDeviceLoginStorage interface.
type MockPendingDeviceLoginStorage struct {
	ctrl     *gomock.Controller
	recorder *MockPendingDeviceLoginStorageMockRecorder
	isgomock struct{}
}

// MockPendingDeviceLoginStorageMockRecorder is the mock recorder for MockPendingDeviceLoginStorage.
type MockPendingDeviceLoginStorageMockRecorder struct {
	mock *MockPendingDeviceLoginStorage
}

// NewMockPendingDeviceLoginStorage creates a new mock instance.
func NewMockPendingDeviceLoginStorage(ctrl *gomock.Controller) *MockPendingDeviceLoginStorage {
	mock := &MockPendingDeviceLoginStorage{ctrl: ctrl}
	mock.recorder = &MockPendingDeviceLoginStorageMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockPendingDeviceLoginStorage) EXPECT() *MockPendingDeviceLoginStorageMockRecorder {
	return m.recorder
}

// DeletePendingDeviceLogin mocks base method.
func (m *MockPendingDeviceLoginStorage) DeletePendingDeviceLogin(ctx context.Context, state string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeletePendingDeviceLogin", ctx, state)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeletePendingDeviceLogin indicates an expected call of DeletePendingDeviceLogin.
func (mr *MockPendingDeviceLoginStorageMockRecorder) DeletePendingDeviceLogin(ctx, state any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeletePendingDeviceLogin", reflect.TypeOf((*MockPendingDeviceLoginStorage)(nil).DeletePendingDeviceLogin), ctx, state)
}

// LoadPendingDeviceLogin mocks base method.
func (m *MockPendingDeviceLoginStorage) LoadPendingDeviceLogin(ctx context.Context, state string) (*storage.PendingDeviceLogin, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LoadPendingDeviceLogin", ctx, state)
	ret0, _ := ret[0].(*storage.PendingDeviceLogin)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// LoadPendingDeviceLogin indicates an expected call of LoadPendingDeviceLogin.
func (mr *MockPendingDeviceLoginStorageMockRecorder) LoadPendingDeviceLogin(ctx, state any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LoadPendingDeviceLogin", reflect.TypeOf((*MockPendingDeviceLoginStorage)(nil).LoadPendingDeviceLogin), ctx, state)
}

// StorePendingDeviceLogin mocks base method.
func (m *MockPendingDeviceLoginStorage) StorePendingDeviceLogin(ctx context.Context, state string, pending *storage.PendingDeviceLogin) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StorePendingDeviceLogin", ctx, state, pending)
	ret0, _ := ret[0].(error)
	return ret0
}

// StorePendingDeviceLogin indicates an expected call of StorePendingDeviceLogin.
func (mr *MockPendingDeviceLoginStorageMockRecorder) StorePendingDeviceLogin(ctx, state, pending any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StorePendingDeviceLogin", reflect.TypeOf((*MockPendingDeviceLoginStorage)(nil).StorePendingDeviceLogin), ctx, state, pending)
}

// MockPendingDeviceConfirmationStorage is a mock of PendingDeviceConfirmationStorage interface.
type MockPendingDeviceConfirmationStorage struct {
	ctrl     *gomock.Controller
	recorder *MockPendingDeviceConfirmationStorageMockRecorder
	isgomock struct{}
}

// MockPendingDeviceConfirmationStorageMockRecorder is the mock recorder for MockPendingDeviceConfirmationStorage.
type MockPendingDeviceConfirmationStorageMockRecorder struct {
	mock *MockPendingDeviceConfirmationStorage
}

// NewMockPendingDeviceConfirmationStorage creates a new mock instance.
func NewMockPendingDeviceConfirmationStorage(ctrl *gomock.Controller) *MockPendingDeviceConfirmationStorage {
	mock := &MockPendingDeviceConfirmationStorage{ctrl: ctrl}
	mock.recorder = &MockPendingDeviceConfirmationStorageMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockPendingDeviceConfirmationStorage) EXPECT() *MockPendingDeviceConfirmationStorageMockRecorder {
	return m.recorder
}

// DeletePendingDeviceConfirmation mocks base method.
func (m *MockPendingDeviceConfirmationStorage) DeletePendingDeviceConfirmation(ctx context.Context, token string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeletePendingDeviceConfirmation", ctx, token)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeletePendingDeviceConfirmation indicates an expected call of DeletePendingDeviceConfirmation.
func (mr *MockPendingDeviceConfirmationStorageMockRecorder) DeletePendingDeviceConfirmation(ctx, token any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeletePendingDeviceConfirmation", reflect.TypeOf((*MockPendingDeviceConfirmationStorage)(nil).DeletePendingDeviceConfirmation), ctx, token)
}

// LoadPendingDeviceConfirmation mocks base method.
func (m *MockPendingDeviceConfirmationStorage) LoadPendingDeviceConfirmation(ctx context.Context, token string) (*storage.PendingDeviceConfirmation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LoadPendingDeviceConfirmation", ctx, token)
	ret0, _ := ret[0].(*storage.PendingDeviceConfirmation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// LoadPendingDeviceConfirmation indicates an expected call of LoadPendingDeviceConfirmation.
func (mr *MockPendingDeviceConfirmationStorageMockRecorder) LoadPendingDeviceConfirmation(ctx, token any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LoadPendingDeviceConfirmation", reflect.TypeOf((*MockPendingDeviceConfirmationStorage)(nil).LoadPendingDeviceConfirmation), ctx, token)
}

// StorePendingDeviceConfirmation mocks base method.
func (m *MockPendingDeviceConfirmationStorage) StorePendingDeviceConfirmation(ctx context.Context, token string, pending *storage.PendingDeviceConfirmation) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StorePendingDeviceConfirmation", ctx, token, pending)
	ret0, _ := ret[0].(error)
	return ret0
}

// StorePendingDeviceConfirmation indicates an expected call of StorePendingDeviceConfirmation.
func (mr *MockPendingDeviceConfirmationStorageMockRecorder) StorePendingDeviceConfirmation(ctx, token, pending any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StorePendingDeviceConfirmation", reflect.TypeOf((*MockPendingDeviceConfirmationStorage)(nil).StorePendingDeviceConfirmation), ctx, token, pending)
}
...
// DeletePendingDeviceConfirmation mocks base method.
func (m *MockStorage) DeletePendingDeviceConfirmation(ctx context.Context, token string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeletePendingDeviceConfirmation", ctx, token)
	ret0, _ := ret[0].(error)
	return ret0
...
// DeletePendingDeviceConfirmation indicates an expected call of DeletePendingDeviceConfirmation.
func (mr *MockStorageMockRecorder) DeletePendingDeviceConfirmation(ctx, token any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeletePendingDeviceConfirmation", reflect.TypeOf((*MockStorage)(nil).DeletePendingDeviceConfirmation), ctx, token)
}

// DeletePendingDeviceLogin mocks base method.
func (m *MockStorage) DeletePendingDeviceLogin(ctx context.Context, state string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeletePendingDeviceLogin", ctx, state)
	ret0, _ := ret[0].(error)
	return ret0
...
// DeletePendingDeviceLogin indicates an expected call of DeletePendingDeviceLogin.
func (mr *MockStorageMockRecorder) DeletePendingDeviceLogin(ctx, state any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeletePendingDeviceLogin", reflect.TypeOf((*MockStorage)(nil).DeletePendingDeviceLogin), ctx, state)
}
...
// LoadPendingDeviceConfirmation mocks base method.
func (m *MockStorage) LoadPendingDeviceConfirmation(ctx context.Context, token string) (*storage.PendingDeviceConfirmation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LoadPendingDeviceConfirmation", ctx, token)
	ret0, _ := ret[0].(*storage.PendingDeviceConfirmation)
	ret1, _ := ret[1].(error)
...
// LoadPendingDeviceConfirmation indicates an expected call of LoadPendingDeviceConfirmation.
func (mr *MockStorageMockRecorder) LoadPendingDeviceConfirmation(ctx, token any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LoadPendingDeviceConfirmation", reflect.TypeOf((*MockStorage)(nil).LoadPendingDeviceConfirmation), ctx, token)
}

// LoadPendingDeviceLogin mocks base method.
func (m *MockStorage) LoadPendingDeviceLogin(ctx context.Context, state string) (*storage.PendingDeviceLogin, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LoadPendingDeviceLogin", ctx, state)
	ret0, _ := ret[0].(*storage.PendingDeviceLogin)
	ret1, _ := ret[1].(error)
...
// LoadPendingDeviceLogin indicates an expected call of LoadPendingDeviceLogin.
func (mr *MockStorageMockRecorder) LoadPendingDeviceLogin(ctx, state any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LoadPendingDeviceLogin", reflect.TypeOf((*MockStorage)(nil).LoadPendingDeviceLogin), ctx, state)
}
...
// StorePendingDeviceConfirmation mocks base method.
func (m *MockStorage) StorePendingDeviceConfirmation(ctx context.Context, token string, pending *storage.PendingDeviceConfirmation) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StorePendingDeviceConfirmation", ctx, token, pending)
	ret0, _ := ret[0].(error)
	return ret0
...
// StorePendingDeviceConfirmation indicates an expected call of StorePendingDeviceConfirmation.
func (mr *MockStorageMockRecorder) StorePendingDeviceConfirmation(ctx, token, pending any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StorePendingDeviceConfirmation", reflect.TypeOf((*MockStorage)(nil).StorePendingDeviceConfirmation), ctx, token, pending)
}

// StorePendingDeviceLogin mocks base method.
func (m *MockStorage) StorePendingDeviceLogin(ctx context.Context, state string, pending *storage.PendingDeviceLogin) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StorePendingDeviceLogin", ctx, state, pending)
	ret0, _ := ret[0].(error)
	return ret0
...
// StorePendingDeviceLogin indicates an expected call of StorePendingDeviceLogin.
func (mr *MockStorageMockRecorder) StorePendingDeviceLogin(ctx, state, pending any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StorePendingDeviceLogin", reflect.TypeOf((*MockStorage)(nil).StorePendingDeviceLogin), ctx, state, pending)
}
