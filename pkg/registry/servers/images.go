// Package servers provides functionality to build and retrieve MCP server images.
package servers
...
// func GetMCPServer(ctx context.Context, serverOrImage string) (*registry.ImageMetadata, error) {
// TODO: Look at what CACertPath is being used for
func GetMCPServer(
	ctx context.Context,
