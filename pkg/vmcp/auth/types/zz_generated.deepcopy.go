...
func (in *TokenExchangeConfig) DeepCopyInto(out *TokenExchangeConfig) {
	*out = *in
	...
	if in.Raw != nil {
		...
		*out = new(TokenExchangeRawAuthConfig)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TokenExchangeRawAuthConfig) DeepCopyInto(out *TokenExchangeRawAuthConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TokenExchangeRawAuthConfig.
func (in *TokenExchangeRawAuthConfig) DeepCopy() *TokenExchangeRawAuthConfig {
	if in == nil {
		return nil
	}
	out := new(TokenExchangeRawAuthConfig)
