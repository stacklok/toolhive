...
![Version: 0.30.2](https://img.shields.io/badge/Version-0.30.2-informational?style=flat-square)
...
| operator.image | string | `"ghcr.io/stacklok/toolhive/operator:v0.30.2"` | Container image for the operator |
...
| operator.toolhiveRunnerImage | string | `"ghcr.io/stacklok/toolhive/proxyrunner:v0.30.2"` | Image to use for Toolhive runners |
| operator.vmcpImage | string | `"ghcr.io/stacklok/toolhive/vmcp:v0.30.2"` | Image to use for Virtual MCP Server (vMCP) deployments |
