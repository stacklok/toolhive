...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CapabilitiesSummary) DeepCopyInto(out *CapabilitiesSummary) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CapabilitiesSummary.
func (in *CapabilitiesSummary) DeepCopy() *CapabilitiesSummary {
	if in == nil {
		return nil
	}
	out := new(CapabilitiesSummary)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MCPGroupSpec) DeepCopyInto(out *MCPGroupSpec) {
	*out = *in
	if in.RegisteredClients != nil {
		in, out := &in.RegisteredClients, &out.RegisteredClients
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
