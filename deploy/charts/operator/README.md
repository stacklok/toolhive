...
| operator.image | string | `"ghcr.io/stacklok/toolhive/operator:v0.4.0"` | Container image for the operator |
...
| operator.toolhiveRunnerImage | string | `"ghcr.io/stacklok/toolhive/proxyrunner:v0.4.0"` | Image to use for Toolhive runners |
