...
| registryAPI | object | `{"image":"ghcr.io/stacklok/thv-registry-api:v0.3.4","serviceAccount":{"annotations":{},"automountServiceAccountToken":true,"labels":{},"name":"toolhive-registry-api"}}` | All values for the registry API deployment and associated resources |
| registryAPI.image | string | `"ghcr.io/stacklok/thv-registry-api:v0.3.4"` | Container image for the registry API |
