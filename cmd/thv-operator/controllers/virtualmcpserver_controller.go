...
func (r *VirtualMCPServerReconciler) ensureDeployment(
	...
	if errors.IsNotFound(err) {
		return r.createVirtualMCPServerDeployment(ctx, vmcp, vmcpConfigChecksum, telemetryCfg, typedWorkloads)
	}
	if err != nil {
	...
	return r.syncExistingVirtualMCPServerDeployment(ctx, vmcp, deployment, vmcpConfigChecksum, telemetryCfg, typedWorkloads)
}

func (r *VirtualMCPServerReconciler) createVirtualMCPServerDeployment(
	ctx context.Context,
	vmcp *mcpv1beta1.VirtualMCPServer,
...
func (r *VirtualMCPServerReconciler) syncExistingVirtualMCPServerDeployment(
	ctx context.Context,
	vmcp *mcpv1beta1.VirtualMCPServer,
	deployment *appsv1.Deployment,
	vmcpConfigChecksum string,
