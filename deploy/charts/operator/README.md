...
| operator.image | string | `"ghcr.io/stacklok/toolhive/operator:v0.1.0"` | Container image for the operator |
...
| operator.toolhiveRunnerImage | string | `"ghcr.io/stacklok/toolhive:v0.1.0"` | Image to use for Toolhive runners |
