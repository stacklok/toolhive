...
//
//	mockgen -destination=mocks/mock_storage.go -package=mocks -source=storage.go Storage,IDPTokenStorage
//
...
import (
	...
	authserver "github.com/stacklok/toolhive/pkg/authserver"
...
func (m *MockStorage) GetIDPTokens(ctx context.Context, sessionID string) (*authserver.IDPTokens, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetIDPTokens", ctx, sessionID)
	ret0, _ := ret[0].(*authserver.IDPTokens)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStorage) StoreIDPTokens(ctx context.Context, sessionID string, tokens *authserver.IDPTokens) error {
	m.ctrl.T.Helper()
...
// GetIDPTokens mocks base method.
func (m *MockIDPTokenStorage) GetIDPTokens(ctx context.Context, sessionID string) (*authserver.IDPTokens, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetIDPTokens", ctx, sessionID)
	ret0, _ := ret[0].(*authserver.IDPTokens)
	ret1, _ := ret[1].(error)
...
// StoreIDPTokens mocks base method.
func (m *MockIDPTokenStorage) StoreIDPTokens(ctx context.Context, sessionID string, tokens *authserver.IDPTokens) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StoreIDPTokens", ctx, sessionID, tokens)
	ret0, _ := ret[0].(error)
	return ret0
