...
func (r *VirtualMCPServerReconciler) ensureVmcpConfigConfigMap(
	...
	// If OutgoingAuth source is "discovered" or "mixed", we need to discover and include
	// ExternalAuthConfig from MCPServers in the ConfigMap
	if config.OutgoingAuth != nil && (config.OutgoingAuth.Source == "discovered" || config.OutgoingAuth.Source == "mixed") {
