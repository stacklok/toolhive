...
type VirtualMCPServerSpec struct {
	...
	// status.conditions with Reason: UnsupportedAuthType. Backends whose configured
	// authentication cannot be resolved are excluded from routing while valid peers
	// remain available.
	// +optional
