...
// ErrLegacyFormat indicates the input is in the legacy ToolHive registry
// format. The legacy format is no longer accepted at runtime; users should
// migrate via `thv registry convert`.
