...
func (p *TransparentProxy) IsRunning(ctx context.Context) (bool, error) {
	p.mutex.Lock()
	defer p.mutex.Unlock()
...
func (p *TransparentProxy) GetMessageChannel() chan *JSONRPCMessage {
	return nil
}

// GetResponseChannel returns the channel for receiving messages from the destination.
// This is not used in the TransparentProxy implementation as it forwards HTTP requests directly.
func (p *TransparentProxy) GetResponseChannel() <-chan *JSONRPCMessage {
	return nil
}

// SendMessageToDestination sends a message to the destination.
// This is not used in the TransparentProxy implementation as it forwards HTTP requests directly.
func (p *TransparentProxy) SendMessageToDestination(msg *JSONRPCMessage) error {
...
// This is not used in the TransparentProxy implementation as it forwards HTTP requests directly.
func (p *TransparentProxy) ForwardResponseToClients(ctx context.Context, msg *JSONRPCMessage) error {
...
// This is not used in the TransparentProxy implementation as it forwards HTTP requests directly.
func (p *TransparentProxy) SendResponseMessage(msg *JSONRPCMessage) error {
