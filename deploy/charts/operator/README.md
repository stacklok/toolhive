...
| operator.image | string | `"ghcr.io/stacklok/toolhive/operator:v0.19.0"` | Container image for the operator |
...
| operator.toolhiveRunnerImage | string | `"ghcr.io/stacklok/toolhive/proxyrunner:v0.19.0"` | Image to use for Toolhive runners |
