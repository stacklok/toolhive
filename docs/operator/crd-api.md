...
| `raw` _[api.v1beta1.TokenExchangeRawConfig](#apiv1beta1tokenexchangerawconfig)_ | Raw holds extension configuration for non-standard token exchange flows.<br />Required when variant is "raw". Optional for named variants. |  | Optional: \{\} <br /> |


#### api.v1beta1.TokenExchangeRawConfig
