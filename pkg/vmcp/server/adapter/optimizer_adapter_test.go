...
func TestCreateOptimizerTools(t *testing.T) {
	...
	tools := CreateOptimizerTools(provider)
...
func TestCreateOptimizerTools_NilProvider(t *testing.T) {
	...
	tools := CreateOptimizerTools(nil)

	require.Nil(t, tools)
}

func TestCreateOptimizerToolsFromProvider(t *testing.T) {
	t.Parallel()

	provider := &mockOptimizerHandlerProvider{}
	tools, err := CreateOptimizerToolsFromProvider(provider)
...
func TestCreateOptimizerToolsFromProvider_NilProvider(t *testing.T) {
	t.Parallel()

	tools, err := CreateOptimizerToolsFromProvider(nil)
