...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OIDCConfigMapRef) DeepCopyInto(out *OIDCConfigMapRef) {
	*out = *in
	if in.CABundleRef != nil {
		in, out := &in.CABundleRef, &out.CABundleRef
		*out = new(CABundleSource)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OIDCConfigMapRef.
func (in *OIDCConfigMapRef) DeepCopy() *OIDCConfigMapRef {
	if in == nil {
		return nil
	}
	out := new(OIDCConfigMapRef)
