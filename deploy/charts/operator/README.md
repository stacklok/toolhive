...
![Version: 0.47.1](https://img.shields.io/badge/Version-0.47.1-informational?style=flat-square)
...
| operator.image | string | `"ghcr.io/stacklok/toolhive/operator:v0.47.1"` | Container image for the operator |
...
| operator.toolhiveRunnerImage | string | `"ghcr.io/stacklok/toolhive/proxyrunner:v0.47.1"` | Image to use for Toolhive runners |
