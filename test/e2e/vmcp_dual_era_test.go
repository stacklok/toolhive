...
// requests (principal A, sessionID, legacyToolName) and perEra concurrent
// Modern tools/call requests (principal B, stateless, modernToolName) --
...
func fireConcurrentBridgedBatch(
	client *e2e.RawMCPClient, url, sessionID, legacyToolName, modernToolName string, perEra, round int,
) []crossDeliveryResult {
