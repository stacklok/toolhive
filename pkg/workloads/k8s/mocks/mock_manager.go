...
// Source: github.com/stacklok/toolhive/pkg/workloads/k8s (interfaces: Manager)
//
// Generated by this command:
//
//	mockgen -destination=mocks/mock_manager.go -package=mocks github.com/stacklok/toolhive/pkg/workloads/k8s Manager
//
...
func (m *MockManager) ListWorkloads(ctx context.Context, listAll bool, labelFilters ...string) ([]k8s.Workload, error) {
	m.ctrl.T.Helper()
