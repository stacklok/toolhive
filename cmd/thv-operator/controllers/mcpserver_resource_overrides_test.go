...
func TestResourceOverrides(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			deployment := r.deploymentForMCPServer(ctx, tt.mcpServer, "test-checksum", "test-revision")
...
func TestDeploymentNeedsUpdateProxyEnv(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			needsUpdate := r.deploymentNeedsUpdate(context.Background(), deployment, tt.mcpServer, "test-checksum", "test-revision")
